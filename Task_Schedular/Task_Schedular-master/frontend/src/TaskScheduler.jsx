...
const TaskScheduler = () => {
  ...
  useEffect(() => {
    ...
    const checkDeadlines = () => {
      ...
      upcomingTasks.forEach((task) => {
        ...
        if (!notifications.find((n) => n.taskId === task.id)) {
          setNotifications((prev) => [
            ...prev,
            {
              id: Date.now() + Math.random(),
              taskId: task.id,
              message: `"${task.title}" is due in ${hoursDiff} hour${
                hoursDiff !== 1 ? "s" : ""
              }!`,
              timestamp: now,
  ...
  const handleSubmitTask = () => {
    ...
    if (editingTask) {
      api
        .put(`/tasks/${editingTask.id}`, taskForm)
        .then((res) => {
          setTasks(
            tasks.map((task) =>
      ...
      api
        ...
        .catch((err) => alert(err.message || "Failed to add task"));
    }
    setTaskForm({
      title: "",
      description: "",
  ...
  const toggleTaskStatus = (taskId) => {
    ...
    if (task) {
      ...
      api
        .put(`/tasks/${taskId}`, updated)
        .then((res) => {
          setTasks(tasks.map((t) => (t.id === taskId ? res.data : t)));
        })
        .catch((err) => alert(err.message || "Failed to toggle task status"));
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {isLoadingTasks && (
          <div className="mb-6 flex items-center justify-center text-gray-500 text-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow p-6 hover-lift slide-in-left">
            <div className="flex items-center">
          ...
          <div className="bg-white rounded-lg shadow p-6 hover-lift slide-in-bottom">
            <div className="flex items-center">
          ...
          <div className="bg-white rounded-lg shadow p-6 hover-lift slide-in-right">
            <div className="flex items-center">
              <div className="p-2 bg-orange-100 rounded-lg hover-scale">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <button
            ...
            className="flex items-center bg-indigo-600 text-white px-4 py-2 rounded-lg btn-primary hover-scale"
          >
        ...
        {showTaskForm && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50 fade-in">
            <div className="bg-white rounded-lg p-6 w-full max-w-md scale-in">
              ...
              <div className="flex space-x-3 mt-6">
                <button
                  ...
                  className="flex-1 bg-indigo-600 text-white py-2 px-4 rounded-md btn-primary hover-scale"
                >
        ...
        <div className="space-y-4">
          {sortedTasks.length === 0 ? (
            <div className="text-center py-12">
              ...
              <button
                onClick={() => setShowTaskForm(true)}
                className="bg-indigo-600 text-white px-4 py-2 rounded-lg btn-primary hover-scale"
              >
                Add Task
              </button>
            </div>
            ...
            sortedTasks.map((task, index) => {
              ...
              return (
                <div
                  key={task.id}
                  className={`bg-white rounded-lg shadow p-6 border-l-4 task-card ${
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex items-start space-x-3">
                      <button
                        ...
                        className={`mt-1 h-5 w-5 rounded border-2 flex items-center justify-center transition-all hover-scale ${
                    ...
                    <div className="flex items-center space-x-2">
                      <button
                        ...
                        className="text-gray-400 hover:text-indigo-600 transition-all hover-scale"
                      >
                        <Edit2 className="h-4 w-4" />
                      </button>
                      <button
                        onClick={() => handleDeleteTask(task.id)}
                        className="text-gray-400 hover:text-red-600 transition-all hover-scale"
                      >
